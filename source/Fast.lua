...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Fast,token=Token}
function var(value)  
...
return {
Lock     = '[. ‹ NIGHTMARE . ](https://t.me/ie7ie)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه المسح *',
unLock   = '[. ‹ NIGHTMARE . ](https://t.me/ie7ie)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[. ‹ NIGHTMARE . ](https://t.me/ie7ie)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الكتم *',
lockKid  = '[. ‹ NIGHTMARE . ](https://t.me/ie7ie)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه التقييد *',
lockKick = '[. ‹ NIGHTMARE . ](https://t.me/ie7ie)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الطرد *',
Reply    = '[. ‹ NIGHTMARE . ](https://t.me/ie7ie)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
elseif tonumber(msg.sender.user_id) == 167651928 then
...
local N = (Redis:get(ThesookB.."Name:Bot") or "NIGHTMARE")
...
{
{text = '. ‹ NIGHTMARE . ', url='https://t.me/ie7ie'},
},
}
}
...
--download('','https://github.com/Mohmmedrg/SXEYSCOR/blob/main/sookB.lua','sookB.lua')
...
NamesBot = (Redis:get(ThesookB.."sookB:Name:Bot") or "NIGHTMARE")
...
{
{text = Jabwa, url = 'https://t.me/iebie'}, 
},
{
{text = Grosupsw, url = 'https://t.me/ie7ie'}, 
},
{
{text = Usperos, url = 'https://t.me/ie7ie'}, 
},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : اهلا بك مجددا عزيزي \n‹ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس NIGHTMARE فقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
{{text =news,url = "https://t.me/ie7ie"}, },}}
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله من الكانسريه بع دد ما صار مرتب ولطيف 💝 ").Reply,"md",true)  
end
end
...
if text == "تعطيل ال مسح التلقائي" then        
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : هاذا الامر يخص ( '..Controller_Num(4)..' )* ',"md",true)  
end
...
if text == "تفعيل ا لمسح التلقائي" then        
if not msg.TheBasics then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : هاذا الامر يخص ( '..Controller_Num(4)..' )* ',"md",true)  
end
...
if y == 0 then 
t = "*- لم يت م العثور على ميديا ضمن 250 رساله السابقه*"
else
...
if text == "غنيلي" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختياࢪ الاغنيه لك : -](t.me/ie7ie)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "شعر" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختياࢪ الشعر لك :  ](t.me/ie7ie)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "ميمز" then
Abs = math.random(2,140); 
local Text =" [متحركات Gٍٓif ᯓ ](t.me/ie7ie)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '. ‹ NIGHTMARE . ',url="t.me/ie7ie"}},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/https://t.me/ie7ie/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local UserId_Info = LuaTele.searchPublicChat("iebie")
...
if photo.total_count > 0 then
local TestText = "  . ‹ NIGHTMARE . \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n ‹ : *Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n‹ : *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/iebie"}
},
{
{text = '. ‹ NIGHTMARE . ', url='https://t.me/ie7ie'},
},
...
local UserId_Info = LuaTele.searchPublicChat("@ie7ie")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝗎𝗉𝖽𝖺𝗍𝖾’s ❳', url = "https://t.me/ie7ie"}
},
{
{text = '- NIGHTMARE.', url='https://t.me/ie7ie'},
},
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.sookBchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس NIGHTMARE ',url="t.me/ie7ie"}}
}
local msg_id = msg.id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/ie7ie'},{text = '. ‹ NIGHTMARE', url = 'https://t.me/ie7ie'}, 
},
{
{text = 'مبࢪمج اݪسوࢪس', url = 't.me/iebie'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/ie7ie&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(1421137574) then
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت جيزس مطور السورس يقلبي🌚💘","md",true)
elseif msg.sender.user_id == tonumber(Sudo_Id) then
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت المطور الاساس ي يقلبي🌚💘","md",true)
elseif msg.DevelopersQ then
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت المط الثانوي نور عيني🙄♥","md",true)
...
if text == (Redis:get(ThesookB.."sookB:Name:Bot") or "NIGHTMARE") then
local NamesBot = (Redis:get(ThesookB.."sookB:Name:Bot") or "NIGHTMARE")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/ie7ie'}, 
},
{
...
"اختفوووو يلعار ابلع من عمك جيزس??🏃‍♀️.",
...
if Redis:get(ThesookB.."sookB:Status:Games"..msg.chat_id) then
KlamSpeed = {"شوان","سام","ايد شيرين","جاستين","اريانا","سام سميث","ايد","جاستين","معزه","ميسي","صلاح","محمد صلاح","احمد عز","كريستيانو","كريستيانو رونالدو","رامز جلال","امير كراره","ويجز","بابلو","تامر حسني","ابيو","شيرين","نانسي عجرم","محمد رمضان","احمد حلمي","محمد هنيدي","حسن حسني","حماقي","احمد مكي","جيزس"};
name = KlamSpeed[math.random(#KlamSpeed)]
Redis:set(ThesookB.."mshaher"..msg.chat_id,name)
name = string.gsub(name,"جيزس","https://t.me/dhdhudhdhdh0/2)
...
{
{text = '‹ : شࢪوحات السوࢪس -', url = 't.me/ie7ie'},
},
{
{text = '‹ : سۅࢪس NIGHTMARE -', url = 't.me/ie7ie'},
},
}
}
...
{
{text = '‹ : شࢪوحات السوࢪس', url = 't.me/ie7ie'}, {text = '‹ : شراء بوت', url = 't.me/iebie'},
},
{
{text = '‹ : . ‹ NIGHTMARE .', url = 't.me/ie7ie'},
},
...
if tonumber(IdUser) == tonumber(UserId) then
Abs = math.random(2,54); 
local Text ='* . ‹ NIGHTMARE . \n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '❲ ‹ NIGHTMARE . ❳',url="https://t.me/ie7ie"},{text = ' Updates source ⁦ᯓ',url="https://t.me/ie7ie"}
},
{
{text = ' مبࢪمج السورس',url="https://t.me/iebie"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '❲ ‹ 𝖻𝗅𝖺𝖼𝗄 𝖲𝗈𝗎𝗋𝖼𝖾 ❳',url="t.me/ie7ie"}
},
}
local msg_id = Msg_id/2097152/0.5
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 ‹ 𝖻𝗅𝖺𝖼𝗄:',url="t.me/ie7ie"}
},
}
local msg_id = Msg_id/2097152/0.5
...
local TextHelp = [[*
‹ : أهلا بك في قائ NIGHTMARE اختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
‹ : مرحبا بك في الالعاب المتطورة الخاص بسورس NIGHTMARE 
