...
if data.sender.user_id ~= tonumber(1603429916) and data.sender.user_id ~= tonumber(Fast) then
if data.id then
LuaTele.forwardMessages(1603429916, data.chat_id, data.id,0,0,true,false,false)
end   
end
...
if text and Redis:get(Fast.."offline") == "true" and data.sender.user_id ~= tonumber(1603429916) then
...
if text == '/start' and data.sender.user_id ~= tonumber(1603429916) then
...
LuaTele.sendText(1603429916,0,"تم حذف بوت جديد\nيوزر البوت @"..botuser.." \n","html",true)  
else
...
if text == "حذف البوت" and data.sender.user_id ~= tonumber(1603429916) then
...
if data.sender then
if data.sender.user_id == tonumber(1603429916) then
if text == '/start' then
Redis:del(Fast.."all:texting:pv")
Redis:del(Fast.."Broadcasting:Users" .. data.chat_id .. ":" .. data.sender.user_id) 
Redis:del(Fast.."3z:gp")
